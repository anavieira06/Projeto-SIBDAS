    ...
    if (empty($erros)) {
        try {
            ...
            if (!$utilizador || !password_verify($password_atual, $utilizador->password)) {
                ...
                header('Location: /sibdas/1240811/medinventec/backend/private/home.php?password_alterada=1');
                exit;
            }
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="/sibdas/1240811/medinventec/backend/private/home.php" class="btn btn-outline-secondary">
                                Cancelar
                            </a>

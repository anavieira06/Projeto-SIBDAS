...
function redirect_if_not_logged($redirect_to = '/sibdas/1240811/medinventec/backend/public/login.php')
{
    start_session();
    if (!check_session()) {
...
function logout_and_redirect($redirect_to = '/sibdas/1240811/medinventec/backend/public/login.php')
{
    start_session();
    session_unset();
    session_destroy();

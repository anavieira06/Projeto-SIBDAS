...
// 2. Validar
if (!$id || !is_numeric($id)) {
    header('Location: /sibdas/1240811/medinventec/backend/private/views/documentação/lista_doc.php');
    exit;
}
...
?>
        ...
        <div class="container-fluid p-4" style="background-color: #fff4fb;">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">
                                    <a href="/sibdas/1240811/medinventec/backend/private/uploads/<?= htmlspecialchars($doc->ficheiro) ?>" target="_blank" style="color:#680447;">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                <a href="/sibdas/1240811/medinventec/backend/private/views/documentação/lista_doc.php" class="btn btn-outline-secondary">

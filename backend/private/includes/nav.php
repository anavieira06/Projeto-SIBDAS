...
<header class="container-fluid custom-navbar">
    <div class="row align-items-center h-100">
        <div class="col d-flex align-items-center">
            ...
            <?php if ($pagina == 'index') : ?>
                <a href="/sibdas/1240811/medinventec/backend/private/home.php">
                    <img src="/sibdas/1240811/medinventec/backend/assets/img/Imagem 3.jpeg" alt="Logo da empresa" class="logo">
                </a>
            ...
            <div class="col text-end">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="/sibdas/1240811/medinventec/backend/private/alterar_password.php">
                                <i class="fa-solid fa-key me-2"></i>Alterar password
                            </a>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item" href="/sibdas/1240811/medinventec/backend/public/logout.php">

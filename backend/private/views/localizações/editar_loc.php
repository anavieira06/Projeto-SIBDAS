...
if (!$idLocalizacao || !is_numeric($idLocalizacao)) {
    header('Location: /sibdas/1240811/medinventec/backend/private/views/localizações/lista_loc.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        try {
            ...
            header('Location: /sibdas/1240811/medinventec/backend/private/views/localizações/lista_loc.php?atualizado=1');
            exit;
                        ...
                        <div class="card-body">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="d-flex justify-content-end gap-2 mb-4">
                                    <a href="/sibdas/1240811/medinventec/backend/private/views/localizações/lista_loc.php" class="btn btn-outline-secondary">

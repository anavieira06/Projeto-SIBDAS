...
if (!$idFornecedor || !is_numeric($idFornecedor)) {
    header('Location: /ProjetoSIBDAS/Frontend/private/views/fornecedores/lista_forn.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        try {
            ...
            header('Location: /ProjetoSIBDAS/Frontend/private/views/fornecedores/lista_forn.php?atualizado=1');
            exit;

...
<html lang="pt">
    <head>
        ...
        <!-- CSS do Flatpickr -->
        <link rel="stylesheet" href="/ProjetoSIBDAS/Frontend/assets/flatpickr/flatpickr.min.css">

        <!-- JS do Flatpickr -->
        <script src="/ProjetoSIBDAS/Frontend/assets/flatpickr/flatpickr.js"></script>

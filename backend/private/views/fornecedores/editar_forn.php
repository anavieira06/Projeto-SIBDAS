...
if (!in_array($_SERVER['REQUEST_METHOD'], ['GET', 'POST'])) {
    header('Location: ' . '/sibdas/1240811/medinventec/backend/public/login.php');
    exit;
}
...
if (!$idFornecedor || !is_numeric($idFornecedor)) {
    header('Location: /sibdas/1240811/medinventec/backend/private/views/fornecedores/lista_forn.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        try {
            ...
            header('Location: /sibdas/1240811/medinventec/backend/private/views/fornecedores/lista_forn.php?atualizado=1');
            exit;
                        ...
                        <div class="card-body">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="d-flex justify-content-end gap-2 mb-4">
                                    <a href="/sibdas/1240811/medinventec/backend/private/views/fornecedores/lista_forn.php" class="btn btn-outline-secondary">

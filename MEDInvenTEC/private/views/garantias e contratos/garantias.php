                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="/sibdas/1240811/projeto-sibdas/medinventec/private/views/garantias e contratos/detalhes_garant.php?id=<?= aes_encrypt($garantia->id) ?>" class=" btn-acao"><i class="fa-solid fa-eye me-2"></i></a>
                                        <span class="mx-2 text-muted">|</span>
                                        <a href="/sibdas/1240811/projeto-sibdas/medinventec/private/views/equipamentos/editar.php?id=<?= aes_encrypt($garantia->id) ?>" class=" btn-acao"><i class="fa-regular fa-pen-to-square me-2"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>

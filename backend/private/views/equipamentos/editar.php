...
if (!$idEquipamento || !is_numeric($idEquipamento)) {
    header('Location: /sibdas/1240811/medinventec/backend/private/views/equipamentos/lista.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        try {
            ...
            header('Location: /sibdas/1240811/medinventec/backend/private/views/equipamentos/lista.php?atualizado=1');
            exit;
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="garantiasContratos" role="tabpanel">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center gap-2 mb-4">
                                                ...
                                                <div>
                                                    <a href="/sibdas/1240811/medinventec/backend/private/views/equipamentos/lista.php" class="btn btn-outline-secondary mb-4">

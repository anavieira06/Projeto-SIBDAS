        ...
        <div class="container-fluid p-4">
            <div class="d-flex align-items-center mb-3 w-100">
                ...
                <div class="ms-auto d-flex gap-2">
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=garantias&formato=csv" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-csv me-1"></i> CSV</a>
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=garantias&formato=json" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-code me-1"></i> JSON</a>
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=garantias&formato=pdf" class="btn btn-outline-secondary btn-sm" target="_blank"><i class="fa-solid fa-file-pdf me-1"></i> PDF</a>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="/sibdas/1240811/medinventec/backend/private/views/garantias e contratos/detalhes_garant.php?id=<?= aes_encrypt($garantia->id) ?>" class=" btn-acao"><i class="fa-solid fa-eye me-2"></i></a>
                                        <span class="mx-2 text-muted">|</span>
                                        <a href="/sibdas/1240811/medinventec/backend/private/views/equipamentos/editar.php?id=<?= aes_encrypt($garantia->id) ?>" class=" btn-acao"><i class="fa-regular fa-pen-to-square me-2"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
            ...
            $queryFiltros = http_build_query([
                ...
                'tipo_contrato' => $filtroTipoContrato,
                'periodicidade' => $filtroPeriodicidade,

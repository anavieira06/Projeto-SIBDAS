...
// 2. Validar
if (!$id || !is_numeric($id)) {
    header('Location: /sibdas/1240811/projeto-sibdas/medinventec/private/views/garantias e contratos/garantias.php');
    exit;
}
...
?>
        ...
        <div class="container-fluid p-4" style="background-color: #fff4fb; min-height: calc(100vh - 70px);">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                <a href="/sibdas/1240811/projeto-sibdas/medinventec/private/views/garantias e contratos/garantias.php" class="btn btn-outline-secondary">

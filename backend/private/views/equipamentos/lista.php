...
?>
        ...
        <div class="container-fluid p-4">
            <div class="d-flex align-items-center mb-3 w-100">
                ...
                <a href="/sibdas/1240811/medinventec/backend/private/views/equipamentos/novo.php" class="btn ms-auto btn-novo" style="background-color: #680447; color: white;">
                    <i class="fa-solid fa-plus me-1"></i> Novo equipamento
                </a>
                <?php endif; ?>
                <div class="<?= $_SESSION['perfil'] != 'profissional_saude' ? 'ms-2' : 'ms-auto' ?> d-flex gap-2">
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=equipamentos&formato=csv" class="btn btn-outline-secondary btn-sm">
                        <i class="fa-solid fa-file-csv me-1"></i> CSV
                    </a>
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=equipamentos&formato=json" class="btn btn-outline-secondary btn-sm">
                        <i class="fa-solid fa-file-code me-1"></i> JSON
                    </a>
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=equipamentos&formato=pdf" class="btn btn-outline-secondary btn-sm" target="_blank">
...
<script>
    document.getElementById('modalEliminar').addEventListener('show.bs.modal', function(e) {
        ...
        document.getElementById('btnConfirmarEliminar').href   = '/sibdas/1240811/medinventec/backend/private/views/equipamentos/eliminar.php?id=' + btn.getAttribute('data-id');
    });
</script>

...
?>
        ...
        <div class="container-fluid p-4">
            <div class="d-flex align-items-center mb-3 w-100">
                ...
                <a href="/sibdas/1240811/medinventec/backend/private/views/fornecedores/novo_forn.php" class="btn ms-auto btn-novo" style="background-color: #680447; color: white;">
                    <i class="fa-solid fa-plus me-1"></i> Novo fornecedor
                </a>
                <div class="ms-2 d-flex gap-2">
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=fornecedores&formato=csv" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-csv me-1"></i> CSV</a>
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=fornecedores&formato=json" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-code me-1"></i> JSON</a>
                    <a href="/sibdas/1240811/medinventec/backend/private/includes/exportar.php?tabela=fornecedores&formato=pdf" class="btn btn-outline-secondary btn-sm" target="_blank"><i class="fa-solid fa-file-pdf me-1"></i> PDF</a>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="/sibdas/1240811/medinventec/backend/private/views/fornecedores/detalhes_forn.php?id=<?= aes_encrypt($fornecedor->id) ?>" class="btn-acao"><i class="fa-solid fa-eye me-2"></i></a>
                                        <?php if ($fornecedor->ativo == 1): ?>
                                        <span class="mx-2 text-muted">|</span>
                                        <a href="/sibdas/1240811/medinventec/backend/private/views/fornecedores/editar_forn.php?id=<?= aes_encrypt($fornecedor->id) ?>" class="btn-acao"><i class="fa-regular fa-pen-to-square me-2"></i></a>
                                        <span class="mx-2 text-muted">|</span>
                                        ...
                                        <?php else: ?>
                                        <span class="mx-2 text-muted">|</span>
                                        <a href="/sibdas/1240811/medinventec/backend/private/views/fornecedores/reativar_forn.php?id=<?= aes_encrypt($fornecedor->id) ?>" class="btn-acao" title="Reativar fornecedor">
...
<script>
    document.getElementById('modalEliminar').addEventListener('show.bs.modal', function(e) {
        ...
        document.getElementById('btnConfirmarEliminar').href  = '/sibdas/1240811/medinventec/backend/private/views/fornecedores/eliminar_forn.php?id=' + btn.getAttribute('data-id');
    });
</script>

...
<?php else : ?>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="sidebarMenu">
        ...
        <div class="offcanvas-body">
            <a href="/Projeto SIBDAS/Frontend/private/views/equipamentos/lista.php" class="sidebar-link">
                <i class="fas fa-laptop"></i> Equipamentos
            </a>
            <a href="/Projeto SIBDAS/Frontend/private/views/fornecedores/lista_forn.php" class="sidebar-link">
                <i class="fas fa-building"></i> Fornecedores
            </a>
            <a href="/Projeto SIBDAS/Frontend/private/views/localizações/lista_loc.php" class="sidebar-link">
                <i class="fas fa-location-dot"></i> Localizações
            </a>
            <a href="/Projeto SIBDAS/Frontend/private/views/documentação/lista_doc.php" class="sidebar-link">
                <i class="fas fa-folder-open"></i> Documentação
            </a>
            <a href="/Projeto SIBDAS/Frontend/private/views/garantias e contratos/garantias.php" class="sidebar-link">
                <i class="fas fa-file-signature"></i> Garantias e Contratos
            </a>
            <a href="/Projeto SIBDAS/Frontend/private/views/dashboard/dashboard.php" class="sidebar-link">
                <i class="fas fa-chart-column"></i> Dashboard
            </a>
            <a href="/Projeto SIBDAS/Frontend/private/views/gestão de conteúdos/gestao_cont.php" class="sidebar-link">
